...
public class People implements Serializable {
    ...
    /* Context represents and activity, it is used when creating a file as it is associated with
    an activity. It is defined as transient, because it should not be serialized when a Person
    object is transferred to another activity*/
